...
alter group 'ISC Storage' assign members  'gracioda','reddyprf','jupallsr','babuaj';
alter group 'ISC UNIX' assign members  'gracioda','reddyprf','jupallsr','babuaj';
alter group 'ISC DB Services' assign members  'gracioda','reddyprf','jupallsr','babuaj';
alter group 'ISC Wintel' assign members  'gracioda','reddyprf','jupallsr','babuaj';
go
quit
COF
}
