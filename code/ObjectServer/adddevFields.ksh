...
alter table alerts.status add column Discipline  int;
alter table alerts.status add column Layer  int;
alter table alerts.status add column ServiceAffecting  int;
alter table alerts.status add column ImpactedComp  varchar(64);
alter table alerts.status add column NotifyingComp  varchar(64);
go
quit
COF
}
