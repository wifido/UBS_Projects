...
sub SetProbeOrder
{
	...
	if($Region =~ m/EMEA/)
	{
		$ProbeOrder[0] = "ldnsktprod1.ldn.swissbank.com";
		$ProbeOrder[1] = "zursktprod1.zur.swissbank.com";
		$ProbeOrder[2] = "sngsktprod1.sng.swissbank.com";
		$ProbeOrder[3] = "stmsktprod1.stm.swissbank.com";
		$ProbeOrder[4] = "dmzprobe";
		$ProbeOrder[5] = "dmzprobefail";
	}
	elsif($Region =~ m/Americas/)
	{
		$ProbeOrder[0] = "stmsktprod1.stm.swissbank.com";
		$ProbeOrder[1] = "sngsktprod1.sng.swissbank.com";
		$ProbeOrder[2] = "ldnsktprod1.ldn.swissbank.com";
		$ProbeOrder[3] = "zursktprod1.zur.swissbank.com";
		$ProbeOrder[4] = "dmzprobe";
		$ProbeOrder[5] = "dmzprobefail";
	}
	elsif($Region =~ m/APAC/)
	{
		$ProbeOrder[0] = "sngsktprod1.sng.swissbank.com";
		$ProbeOrder[1] = "stmsktprod1.stm.swissbank.com";
		$ProbeOrder[2] = "zursktprod1.zur.swissbank.com";
		$ProbeOrder[3] = "ldnsktprod1.ldn.swissbank.com";
		$ProbeOrder[4] = "dmzprobe";
		$ProbeOrder[5] = "dmzprobefail";
	}
	else
	{
		$ProbeOrder[0] = "zursktprod1.zur.swissbank.com";
		$ProbeOrder[1] = "ldnsktprod1.ldn.swissbank.com";
		$ProbeOrder[2] = "sngsktprod1.sng.swissbank.com";
		$ProbeOrder[3] = "stmsktprod1.stm.swissbank.com";
		$ProbeOrder[4] = "dmzprobe";
		$ProbeOrder[5] = "dmzprobefail";
