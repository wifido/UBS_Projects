...
#	print $socket "'Severity' 'INFO'\n";
	print $socket "'Severity' '4'\n";
#	print $socket "'Severity' 'WARN'\n";
#	print $socket "'Severity' 'ERROR'\n";
#	print $socket "'Severity' 'FATAL'\n";
	print $socket "'Nodealias' 'wldn0140906.develop.ubsw.net'\n";
#	print $socket "'EventIdentifier' 'ECT'\n";
#	print $socket "'SAPname' 'SAPname'\n";
#	print $socket "'Subclass' 'SubClass'\n";
	print $socket "'ClassID' '1057337'\n";
#	print $socket "'MessageText' 'MOM:Summary \n'\n"; 
	print $socket "'EventType' '2'\n";
#	print $socket "'EventTime' '$time'\n";
	print $socket "'Component' 'MOM Agent heartbeat failure'\n";
	print $socket "'AlertKey' 'AlertKey'\n";
	print $socket "'Domain' 'Domain'\n";
	print $socket "'Userint1' '1000001'\n";
	print $socket "'Userdata' 'Userdata'\n";
	print $socket "'UserData1' 'Userdata1'\n";
	print $socket "'Userdata2' 'Userdata2'\n";
	print $socket "'Stream' 'Stream'\n";
	print $socket "'Owner' 'Janesch-J'\n";
