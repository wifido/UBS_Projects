...
#		$internet_addr = inet_aton("stmsktdev2.stm.swissbank.com");
	...
	if(length($internet_addr) > 0 )
	{
		...
		if($MessageConnected == 1)
		{
			...
			print TO_SERVER "'Severity' 'CRITICAL'\n";
			print TO_SERVER "'Nodealias' 'xldn2929dap.ldn.swissbank.com'\n";
			print TO_SERVER "'Profile' '$Profile'\n";
			print TO_SERVER "'EventIdentifier' 'Agent'\n";
			print TO_SERVER "'ClassID' '2300007'\n";
			print TO_SERVER "'MessageText' 'The C: disk is at or near capacity.  You may need to delete some files.'\n"; 
			...
			print TO_SERVER "'Class' '128850'\n";
			print TO_SERVER "'AlertKey' ''\n";
			print TO_SERVER "'AlertGroup' 'Disk is at or near capacity!'\n";
			print TO_SERVER "'OwnerGID' '8'\n";
			print TO_SERVER "'Domain' 'UBSW'\n";
