...
#	print $socket "'Severity' 'FATAL'\n";
	...
	print $socket "'EventIdentifier' 'AlertGroup'\n";
	print $socket "'SAPname' 'SAPname'\n";
	print $socket "'Subclass' 'BIMS_JobServer_Monitor'\n";
	print $socket "'ClassID' '1057438'\n";
	print $socket "'MessageText' 'Summary'\n"; 
#	print $socket "'MessageText' '12345678912345678912345678912345678912345678912345678912345678912Summary,AlertKey,UserData1,UserData2'\n"; 
