...
#		$internet_addr = inet_aton("stmsktdev2.stm.swissbank.com");
	...
	if(length($internet_addr) > 0 )
	{
		...
		if($MessageConnected == 1)
		{
			...
			print TO_SERVER "'MessageText' 'Net This is a Test Event from a random zur DB Services box'\n"; 
			...
			print TO_SERVER "'Class' '468'\n";
			print TO_SERVER "'AlertKey' '\\sbclocal'\n";
			print TO_SERVER "'AlertGroup' 'Disk usage'\n";
			print TO_SERVER "'OwnerGID' '468'\n";
			print TO_SERVER "'Domain' 'DMZ'\n";
