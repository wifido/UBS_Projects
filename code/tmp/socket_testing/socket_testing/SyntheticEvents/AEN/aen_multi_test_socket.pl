...
#	print $socket "'Severity' 'ERROR'\n";
	print $socket "'Severity' '$Sev'\n";
	print $socket "'Nodealias' 'WLDN0144847.develop.ubsw.net'\n";
	print $socket "'EventIdentifier' 'AEN Test Event $Count'\n";
	print $socket "'SAPname' 'SAPname'\n";
	print $socket "'Subclass' '#JustChris:Subclass'\n";
	print $socket "'ClassID' '99999'\n";
	print $socket "'MessageText' 'Testing AEN Please Ignore\n'\n"; 
	print $socket "'EventType' '$Type'\n";
