...
#	print $socket "'Severity' 'FATAL'\n";
	...
	print $socket "'MessageText' 'Process exploded - dummy event please ignore'\n"; 
	...
	print $socket "'Userdata' 'instance=Testing,cluster=Cluster,process=Process'\n";
#	print $socket "'Userdata' 'instance=Testing,cluster=Cluster,process=Process'\n";
#	print $socket "'Userdata' 'instance=janesch,cluster=Cluster,process=dmgr'\n";
	print $socket "\n";
	close($socket);
}
# Send to the dev box
