...
sub do_trap 
{
	...
	my $result = $session->snmpv2_trap(
		...
		'1.3.6.1.6.3.1.1.4.1.0', OBJECT_IDENTIFIER, '.1.3.6.1.4.1.12962.3.1.0.1',
		'.1.3.6.1.4.1.12962.3.1.0.1.1', OCTET_STRING, 'oid1', #OID1
		'.1.3.6.1.4.1.12962.3.1.0.1.2', OCTET_STRING, 'oid2' #OID2
		]
	);
	if (!defined($result)) 
	{
