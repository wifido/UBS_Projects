...
sub do_trap 
{
	...
	my $notify = '.1.3.6.1.4.1.2552.200.300.3.0';
	...
	my $result = $session->snmpv2_trap(
		...
		'1.3.6.1.6.3.1.1.4.1.0', OBJECT_IDENTIFIER, $notify.'.1',
		$notify .'.2', OCTET_STRING, 'smEventComponentName', #varbind1
		$notify .'.10', OCTET_STRING, 'smEventMessage' #varbind2
		]
	);
