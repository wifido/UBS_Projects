...
sub do_trap 
{
	...
	my $result = $session->trap(
		...
		-timestamp	=>	$time,
		-varbindlist	=>	[
		'.1.3.6.1.4.1.1977.30.1.1.3.28', OCTET_STRING, '/var/VRTSvcs/log/engine_A.log', 
		'.1.3.6.1.4.1.1977.30.3.1.3.28.1.2', OCTET_STRING, '2006/03/27 10:32:12 VCS ERROR V-16-1-10205 Group aimsbcpweb_SG01 is faulted on system schi6259dwk',
		'.1.3.6.1.4.1.1977.30.3.1.4.28.1.2', OCTET_STRING, '3', 
		'.1.3.6.1.4.1.1977.30.1.1.14.28', OCTET_STRING, 'ssm_logmon_app_vcs_5:999999:Veritas Cluster Server:3:Unable To Offline Resource' 
		]
	);
	if (!defined($result)) 
	{
