...
sub do_trap 
{
	...
	my $result = $session->trap(
		...
		-timestamp	=>	$time,
		-varbindlist	=>	[
		'.1.3.6.1.4.1.1977.30.1.1.3.28', OCTET_STRING, '/chris/dyn/data/EquityPnl/EC/log/tigerLoad_prod.log.2008-08-04', 
		'.1.3.6.1.4.1.1977.30.3.1.3.28.1.2', OCTET_STRING, 'ssm_logmon_app_5:999999:Software:1:ETL'
#		'.1.3.6.1.4.1.1977.30.3.1.3.28.1.2', OCTET_STRING, 'ssm_logmon_app_5'
		]
	);
	if (!defined($result)) 
	{
