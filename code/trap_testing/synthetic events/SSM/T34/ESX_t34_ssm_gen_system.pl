...
sub do_trap 
{
	...
	my $result = $session->trap(
		...
		'.1.3.6.1.4.1.1977.30.3.1.3.28.1.2', OCTET_STRING, 'ssm_gen_system:123000:SubClass:9:AlertKey', 	# genAlarmControlVariableDescription
		...
		'.1.3.6.1.4.1.1977.30.3.1.3.28.1.10', OCTET_STRING, 'Summary ESX Event'	# genAlarmControlRisingDescription
		]
	);
	if (!defined($result)) 
	{
