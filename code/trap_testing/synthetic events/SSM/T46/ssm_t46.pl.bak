...
sub do_trap 
{
	...
	my $result = $session->trap(
		...
		-timestamp	=>	$time,
		-varbindlist	=>	[
		'.1.3.6.1.4.1.1977.30.1.1.3.28', OCTET_STRING, '/var/log/messages', #	logMonXControlLogFile
		...
		'.1.3.6.1.4.1.1977.30.1.1.14.28', OCTET_STRING, 'SyslogMessage' #	logMonXControlDescription
		]
	);
	if (!defined($result)) 
	{
