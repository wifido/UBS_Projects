...
sub do_trap 
{
	...
	my $result = $session->trap(
		...
		'.1.3.6.1.4.1.1977.30.3.1.3.28.1.2', OCTET_STRING, "Feb 26 19:03:41 shyd0105pbp.hyd.swissbank.com ltid[3551]: [ID 841248 daemon.error] Operator/EMM server has DOWN'ed drive dhyd0049ptl-drive-4 (device 3)", # logMonXHistoryLine 
