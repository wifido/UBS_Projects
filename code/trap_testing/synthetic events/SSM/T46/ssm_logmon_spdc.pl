...
sub do_trap 
{
	...
	my $result = $session->trap(
		...
		'.1.3.6.1.4.1.1977.30.3.1.3.28.1.2', OCTET_STRING, '1 :2 :3 :4 :5 :6 :7 UserData :8 Summary logMonXHistoryLine', # logMonXHistoryLine 
		'.1.3.6.1.4.1.1977.30.3.1.4.28.1.2', OCTET_STRING, '4', #	logMonXHistoryLevel
		'.1.3.6.1.4.1.1977.30.1.1.14.28', OCTET_STRING, 'ssm_logmon_sdpc_5:999999:SubClass:2:AlertGroup' #	logMonXControlDescription
		]
	);
	if (!defined($result)) 
	{
