...
sub do_trap 
{
	...
	my $result = $session->trap(
		...
		-timestamp	=>	$time,
		-varbindlist	=>	[
		'.1.3.6.1.4.1.1977.30.1.1.3.28', OCTET_STRING, 'ssm_arith_disk_per:999999:subclass:1:Disk usage', 
		...
		'.1.3.6.1.4.1.1977.30.3.1.4.28.1.2', OCTET_STRING, '3:\sbclocal:73:70:9090000:10000000:1000', 
		]
	);
	if (!defined($result)) 
	{
...
#	do_trap("xldn1017pap.ldn.swissbank.com", "162");
#	sleep 10;
#}
