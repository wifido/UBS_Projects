...
sub do_trap 
{
	...
	my $result = $session->trap(
		...
		-timestamp	=>	$time,
		-varbindlist	=>	[
		'.1.3.6.1.4.1.1977.30.1.1.3.28', OCTET_STRING, 'ssm_fsmon_system:999999:subclass:1:AlertGroup', 
		...
		'.1.3.6.1.4.1.1977.30.3.1.4.28.1.2', OCTET_STRING, '3:500:250:128:50:28:56:Mount_Point', 
		]
	);
	if (!defined($result)) 
	{
