...
sub do_trap 
{
	...
	my $result = $session->trap(
		...
		-timestamp	=>	$time,
		-varbindlist	=>	[
		'.1.3.6.1.4.1.1977.30.1.1.3.28', OCTET_STRING, 'ssm_ifmon_system:2071002:subclass:1:AlertGroup', 
		...
		'.1.3.6.1.4.1.1977.30.3.1.4.28.1.2', OCTET_STRING, '1:Interface:Average CPU -Cleared', 
		]
	);
	if (!defined($result)) 
	{
